...
class MainWindow(QMainWindow):
    def __init__(self, node):
        ...
        self.canvas_map.mpl_connect('button_press_event', self.on_mouse_press) #마우스 버튼을 누르는 순간
        self.canvas_map.mpl_connect('motion_notify_event', self.on_mouse_move) #마우스를 움직일 때 마다
        self.canvas_map.mpl_connect('button_release_event', self.on_mouse_release) #마우스 버튼을 놓은 순간
