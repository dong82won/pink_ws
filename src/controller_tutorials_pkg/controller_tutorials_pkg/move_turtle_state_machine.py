############### 참고 ####################
# sequance_diagram_move_turtle.mermaid #
########################################
# ros2 run turtlesim turtlesim_node
# ros2 run controller_tutorials_pkg move_turtle_state_machine
# ros2 topic pub --once /goal_pose turtlesim/msg/Pose "{x: 1.,y: 1.5,theta: 0.}"
...
from controller_tutorials_pkg.control_apps import PID
